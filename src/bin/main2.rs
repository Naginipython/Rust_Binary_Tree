// Created by: https://github.com/AbrarNitk/algorithmica/blob/master/algorithmica/src/tree/bst.rs
// It's here to prove to me that Rust can do something like this, simply
// For more clarity: This is not my code
